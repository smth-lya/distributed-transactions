...
public class InventoryReservationCanceledConsumer : IConsumer<InventoryReservationCanceledEvent>, IHostedService
{
    private readonly IServiceScopeFactory _scopeFactory;
    private readonly IMessageSubscriber _subscriber;
    private readonly ILogger<InventoryReservationCanceledConsumer> _logger;
    
    public InventoryReservationCanceledConsumer(
        IServiceScopeFactory scopeFactory, 
        IMessageSubscriber subscriber, 
        ILogger<InventoryReservationCanceledConsumer> logger)
    {
    ...
    public async Task Consume(ConsumeContext<InventoryReservationCanceledEvent> context)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Inventory cancel reservation for Saga {CorrelationId}. Rejecting order {OrderId}. Reason: {Reason}",
        ...
        {
            _logger.LogError(ex, "Error while processing InventoryReservationCanceledEvent for CorrelationId: {CorrelationId}", context.CorrelationId);
            throw;
        }
    }
