...
public class InventoryWorker : BackgroundService
{
    ...
    private ILogger<InventoryWorker> _logger;
    ...
    private async Task HandleReserveItemsCommand(ReserveInventoryCommand arg)
    {
        var message = new InventoryReservedEvent(Guid.NewGuid(), arg.Items)
        {
            CorrelationId = arg.CorrelationId
        };
        
        _logger.LogInformation("HandleReserveItemsCommand");        
        
        await PublishAsync(message, exchange: "saga.fanout.evt", routingKey: "");
    }
